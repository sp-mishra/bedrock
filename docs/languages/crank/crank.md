...
| Multi-resource transactions                                                                    | Implemented (parse) — single-resource enforced at sema (`CRANK-TX-002`)                                                                                          | §7c                     |
...
| Associated types in generics                                                                   | Implemented (sema) — resolved; `CRANK-GEN-006` gate lifted                                                                                                       | §v2.1                   |
| Generic modules                                                                                | Implemented — grammar (`module_decl`) + `module_decl_node` + instantiation library                                                                               | §v2.3                   |
| Const-generic arithmetic                                                                       | Implemented                                                                                                                                                      | §8                      |
